...
def scrap(url,idx):
    ...
    def json_dump(data):
        date=datetime.data.today().strftime("%B %d,%Y")
        with open('moneycontrol_'+ str(date)+'.joson','w') as outfile:
